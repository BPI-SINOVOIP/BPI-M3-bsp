...
{
	__s32               card_ctrl_num;                //?����112|��???��|��???��oy
	__s32				boot_offset;                  //????��??��????��??o��??��????-o��a??���衧a?��???|��?1��1���衧a
	__s32 				card_no[4];                   //|��?��???????��|��???��o?, 16-31:GPIO?������o??��?0-15:��o|��?��o??��????????������o?
	__s32 				speed_mode[4];                //??��|��??����?����??����o??��?0?��o|����a?����?��????��1?��o???����
	__s32				line_sel[4];                  //??��|��??????��?0: 1???��????��1?��?4??
	__s32				line_count[4];                //??�졧o1��????|��???��oy
	__s32  	        	sdc_2xmode[4];
	__s32				ddrmode[4];
	__s32               sdc_f_max[4]; 
