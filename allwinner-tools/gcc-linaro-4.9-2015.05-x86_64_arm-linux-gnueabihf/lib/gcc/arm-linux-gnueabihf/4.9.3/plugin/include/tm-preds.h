/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/tcwg-buildslave/workspace/tcwg-make-release/label/tcwg-x86_64/target/arm-linux-gnueabihf/snapshots/gcc-linaro-4.9-2015.05/gcc/config/arm/arm.md'.  */
