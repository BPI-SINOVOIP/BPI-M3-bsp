	...
	if(twi_id == adapter->nr){
		for(i2c_num = 0; i2c_num < (sizeof(i2c_address)/sizeof(i2c_address[0]));i2c_num++){
			...
			if (err < 0) {
				...
				strlcpy(info->type, LSM9DS0_DEV_NAME, I2C_NAME_SIZE);	
				return 0;
			}
		}
						...
						unsigned int poll_interval_ms)
{
	...
	if (atomic_read(&stat->enabled_acc)) {
		...
		stat->ktime_acc =ktime_set(SEC_PORTION_FROM_MS(poll_interval_ms),
						...
						unsigned int poll_interval_ms)
{
	...
	if (atomic_read(&stat->enabled_mag)) {
		...
		stat->ktime_mag =ktime_set(SEC_PORTION_FROM_MS(poll_interval_ms),
					NSEC_PORTION_FROM_MS(poll_interval_ms));
	}
...
__ATTR(pin1_enable, 0666, attr_get_gen1_status, attr_set_gen1_status);
static struct kobj_attribute gen1_interrupt_pin2_enable =
__ATTR(pin2_enable, 0666, attr_get_gen1_status, attr_set_gen1_status);

static struct kobj_attribute gen2_interrupt_pin1_enable =
__ATTR(pin1_enable, 0666, attr_get_gen2_status, attr_set_gen2_status);
static struct kobj_attribute gen2_interrupt_pin2_enable =
__ATTR(pin2_enable, 0666, attr_get_gen2_status, attr_set_gen2_status);

static struct kobj_attribute gen1_duration =
__ATTR(duration, 0666, attr_get_gen1_duration, attr_set_gen1_duration);
static struct kobj_attribute gen2_duration =
__ATTR(duration, 0666, attr_get_gen2_duration, attr_set_gen2_duration);

static struct kobj_attribute gen1_threshold =
__ATTR(threshold, 0666, attr_get_gen1_threshold, attr_set_gen1_threshold);
static struct kobj_attribute gen2_threshold =
__ATTR(threshold, 0666, attr_get_gen2_threshold, attr_set_gen2_threshold);

static struct kobj_attribute mag_gen_interrupt_pin1 =
__ATTR(pin1_enable, 0666, attr_get_gen_mag_status, attr_set_gen_mag_status);
static struct kobj_attribute mag_gen_interrupt_pin2 =
__ATTR(pin2_enable, 0666, attr_get_gen_mag_status, attr_set_gen_mag_status);

static struct kobj_attribute mag_gen_threshold =
__ATTR(threshold, 0666, attr_get_gen_mag_threshold, attr_set_gen_mag_threshold);

static struct kobj_attribute gen1_x_high =
__ATTR(x_high_enable, 0666, attr_get_gen1_axis, attr_set_gen1_axis);
static struct kobj_attribute gen1_x_low =
__ATTR(x_low_enable, 0666, attr_get_gen1_axis, attr_set_gen1_axis);

static struct kobj_attribute gen2_x_high =
__ATTR(x_high_enable, 0666, attr_get_gen2_axis, attr_set_gen2_axis);
static struct kobj_attribute gen2_x_low =
__ATTR(x_low_enable, 0666, attr_get_gen2_axis, attr_set_gen2_axis);

static struct kobj_attribute gen1_y_high =
__ATTR(y_high_enable, 0666, attr_get_gen1_axis, attr_set_gen1_axis);
static struct kobj_attribute gen1_y_low =
__ATTR(y_low_enable, 0666, attr_get_gen1_axis, attr_set_gen1_axis);

static struct kobj_attribute gen2_y_high =
__ATTR(y_high_enable, 0666, attr_get_gen2_axis, attr_set_gen2_axis);
static struct kobj_attribute gen2_y_low =
__ATTR(y_low_enable, 0666, attr_get_gen2_axis, attr_set_gen2_axis);

static struct kobj_attribute gen1_z_high =
__ATTR(z_high_enable, 0666, attr_get_gen1_axis, attr_set_gen1_axis);
static struct kobj_attribute gen1_z_low =
__ATTR(z_low_enable, 0666, attr_get_gen1_axis, attr_set_gen1_axis);

static struct kobj_attribute gen2_z_high =
__ATTR(z_high_enable, 0666, attr_get_gen2_axis, attr_set_gen2_axis);
static struct kobj_attribute gen2_z_low =
__ATTR(z_low_enable, 0666, attr_get_gen2_axis, attr_set_gen2_axis);

static struct kobj_attribute gen_mag_x =
__ATTR(x_enable, 0666, attr_get_gen_mag_axis, attr_set_gen_mag_axis);
static struct kobj_attribute gen_mag_y =
__ATTR(y_enable, 0666, attr_get_gen_mag_axis, attr_set_gen_mag_axis);
static struct kobj_attribute gen_mag_z =
__ATTR(z_enable, 0666, attr_get_gen_mag_axis, attr_set_gen_mag_axis);

static struct kobj_attribute gen1_and_or =
__ATTR(and(1)_or(0)_combination, 0666, attr_get_gen1_and_or,
							attr_set_gen1_and_or);
static struct kobj_attribute gen2_and_or =
__ATTR(and(1)_or(0)_combination, 0666, attr_get_gen2_and_or,
...
static int __init lsm9ds0_init(void)
{
	...
	lsm9ds0_driver.detect = e_compass_detect;
